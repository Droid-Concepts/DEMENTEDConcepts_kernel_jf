...
rm -rf $PACKAGEDIR/DEMENTEDKernel-JFTMO-*
...
make VARIANT_DEFCONFIG=jf_tmo_defconfig SELINUX_DEFCONFIG=jfselinux_defconfig SELINUX_LOG_DEFCONFIG=jfselinux_log_defconfig DEMENTED_jf_defconfig
